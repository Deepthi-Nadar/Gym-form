<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="start.aspx.cs" Inherits="WebApplication6.start" %>
...
@keyframes pulseGlow {
    from { box-shadow: 0 0 15px orange; }
    to { box-shadow: 0 0 45px orange; }
}
